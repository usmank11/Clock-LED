...
HD_PWD='C:/Users/usman/Desktop/FPGA stuffs/pynqz2-clock/pynqz2-clock.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MainDesign_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MainDesign_wrapper.tcl -notrace
