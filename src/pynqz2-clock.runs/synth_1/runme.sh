...
HD_PWD='C:/Users/usman/Desktop/FPGA stuffs/pynqz2-clock/pynqz2-clock.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MainDesign_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MainDesign_wrapper.tcl
